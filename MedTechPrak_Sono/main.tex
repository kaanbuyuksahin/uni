...
\section{Physikalische Grundlagen des Ultraschall-Dopplers}\label{sec:physik-doppler}
   ...
   \subsubsection{Ruhender Empfänger, bewegte Quelle}\label{sec:doppler-ruhender-empfaenger}
      ...
      In diesem Szenario bewegt sich die Schallquelle radial auf einen ruhenden Empfänger zu (vgl. Abbildung~\ref{fig:ruhender-empfaenger-bewegte-quelle}). Die Quelle bewegt sich mit der Geschwindigkeit \(v_Q\) und emittiert Schallwellen mit der Frequenz \(f_Q\) und der zugehörigen Wellenlänge \(\lambda_Q\).
      \\
...
\section{Doppler-Sonographie zur Blutflussuntersuchung}\label{sec:doppler-sonographie}
   ...
   \subsection{Dopplerwinkel und Brechungsgesetz}\label{subsec:dopplerwinkel}
      ...
      \begin{figure}[ht]
         ...
         \caption{Schematische Darstellung des Brechungsgesetzes einer Schallwelle.}\label{fig:dopplerwinkel}
         \end{figure}
